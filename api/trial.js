...
// اسم مميز لهذا البرنامج/المنتج - لازم يكون فريد ومختلف عن أي برنامج
// تاني بيستخدم نفس قاعدة بيانات الـ KV، حتى لو كانا على نفس الجهاز
// (نفس deviceId)، عشان منفعش يتشاركوا نفس مفاتيح التخزين بالغلط.
const APP_NAME = 'payroll_v25';

const TRIAL_DURATION_MS = 24 * 60 * 60 * 1000; // 24 ساعة
...
export default async function handler(req, res) {
    ...
    const trialKey = `trial:${APP_NAME}:${deviceId}`;
