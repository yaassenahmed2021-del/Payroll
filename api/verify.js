...
// نفس القيمة الموجودة في trial.js و check-status.js بالضبط لهذا البرنامج
const APP_NAME = 'payroll_v25';

// قائمة المفاتيح المسموح بها فقط
const VALID_KEYS = ["SRH-0986-PLOLJ-[]-8"];
...
export default async function handler(req, res) {
    ...
    const licenseRecordKey = `license:${APP_NAME}:${key}`;
    ...
    await kv.set(`device:${APP_NAME}:${deviceId}`, key);
